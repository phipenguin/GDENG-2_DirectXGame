...
Mesh::Mesh(const wchar_t* full_path) : Resource(full_path)
{
	...
	ShaderLibrary::getInstance()->getVertexMeshLayoutShaderByteCodeAndSize(&shader_byte_code, &size_shader);
	m_vertex_buffer_textured = GraphicsEngine::getInstance()->getRenderSystem()->createVertexBufferTextured(&list_vertices[0], sizeof(VertexMesh),
...
const VertexBufferTexturedPtr& Mesh::getVertexBufferTextured()
{
	return this->m_vertex_buffer_textured;
}
