...
VertexBufferTextured::VertexBufferTextured(void* list_vertices, UINT size_vertex, UINT size_list, 
	...
	RenderSystem* system) : m_system((system)), m_layout(0), m_buffer(0)
{
	...
	{
		throw std::exception("VertexBufferTextured not created successfully");
	}
